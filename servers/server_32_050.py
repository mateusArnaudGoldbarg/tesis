...
def load_model():
	...
	caminho_arquivo_zip = 'sp_32_050.zip'
	...
	interpreter = tf.lite.Interpreter('sp_32_050.tflite')
	interpreter.allocate_tensors()
	os.remove('sp_32_050.tflite')
...
def index():
	return '''<h1>Mateus Goldbarg Tesis</h1>
		<p>This server contains the pruned model with alpha equal 0.50 model</p>
	'''

...
def load_model():
	...
	caminho_arquivo_zip = 'm_32_000.zip'
	...
	interpreter = tf.lite.Interpreter('m_32_000.tflite')
	interpreter.allocate_tensors()
	os.remove('m_32_000.tflite')
...
def index():
	return '''<h1>Mateus Goldbarg Tesis</h1>
		<p>This server contains the not compressed model</p>
	'''
